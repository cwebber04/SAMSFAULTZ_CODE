...
#----------DESCRIPTION----------#
#make seismicity plot with ETH-SED catalogue
...
####GRD####
set grd = "/Users/timothylee/polybox/Shared/SAMSFAULTZ/lib/euro30m.grd"
...
####CALTALOGUE####
set catalogue = "/Users/timothylee/polybox/Shared/SAMSFAULTZ/lib/MANULOC_List_1984_2012_ECOS_short.log.latest"
...
set ps = seismicity_schweiz_"$map"_"$cpt"_"$east"_"$west"_"$south"_"$north"_"$comment".ps
####GMT_SET####
