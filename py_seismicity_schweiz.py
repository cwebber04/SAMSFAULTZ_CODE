...
plt.plot
plt.savefig('py_seismicity_schweiz_global.png')
plt.show()
...
for label, xpt, ypt, x_offset, y_offset in zip(labels, x, y, x_offsets, y_offsets):
	plt.text(xpt+x_offset, ypt+y_offset, label)
plt.plot
plt.savefig('py_seismicity_schweiz_regional.png')
plt.show()
...
plt.plot
plt.savefig('py_seismicity_schweiz_hypo.png')
plt.show()
...
plt.ylabel("count")
plt.plot
plt.savefig('py_seismicity_schweiz_histo_time.png')
plt.show()
...
plt.ylabel("count")
plt.plot
plt.savefig('py_seismicity_schweiz_histo_depth.png')
plt.show()
...
plt.ylabel("count")
plt.plot
plt.savefig('py_seismicity_schweiz_histo_mag.png')
plt.show()
